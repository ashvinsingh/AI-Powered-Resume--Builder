      ...
      <div className="min-h-screen pb-20">
        ...
        >
          ...
          <button
            ...
            className="active:ring-3 active:ring-white aspect-square size-10 p-1 flex items-center justify-center bg-green-600 hover:bg-green-700 transition text-white rounded-md"
          >
            X
          </button>
        </div>
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          <div className="absolute top-28 xl:top-10 -z-10 left-1/4 size-72 sm:size-96 xl:size-[30rem] bg-green-300 blur-[100px] opacity-30"></div>
          ...
          <div className="flex flex-wrap justify-between max-sm:justify-center gap-6 max-w-3xl w-full mx-auto py-4">
            {logos.map((logo, i) => (
              <img
                ...
                src={logo}
                alt="company logo"
                className="h-6 w-auto max-w-xs opacity-70 hover:opacity-100 transition"
              />
            ))}
          </div>
        </div>
