...
const ProfessionalSummaryForm = ({ data, onChange }) => {
  ...
  const generateSummary = async () => {
    const currentSummary = (data || "").trim(); // ensure it's always a string
    ...
    try {
      ...
      const prompt = `Enhance and improve this professional summary without removing its content: "${currentSummary}"`;
